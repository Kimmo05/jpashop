...
import kr.co.pjshop.entity.MemberAddress;
...
public class MemberServiceImpl implements UserDetailsService, MemberService {
    ...
    @Override
    public Page<Member> findAllMemberByOrderByRegTime(Pageable pageable) {
        return memberRepository.findAllByOrderByRegTime(pageable);
    }
